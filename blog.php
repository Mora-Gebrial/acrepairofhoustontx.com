...
$blog->my['siteurl'] = 'https://www.acrepairofhoustontx.com/';
...
<html lang="en">
<head>
<base href="https://www.acrepairofhoustontx.com/" />
    <meta charset="UTF-8">
...
$blog->head(); ?>
    ...
    <meta property="og:url" content="https://www.acrepairofhoustontx.com/" />
    <meta property="og:image" content="https://www.acrepairofhoustontx.com/images/favicon.webp" />
    ...
    <script type="application/ld+json">
        ...
        "image": "https://www.acrepairofhoustontx.com/images/favicon.webp",
        "url": "https://www.acrepairofhoustontx.com/",
        "telephone": "713-487-8471 ",
        "email" : "service@acrepairofhoustontx.com",
        ...
        <div class="row py-2 px-lg-5">
            <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center text-white">
                    ...
                    <small><i class="fa fa-envelope mr-2"></i>service@acrepairofhoustontx.com</small>
                </div>
            </div>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5" >
            <div style="margin-left: 80px;">
                <a href="https://www.acrepairofhoustontx.com/" class="navbar-brand ml-lg-3 " >

                    <img src="images/logo.webp" alt="logo.webp" title="Services For Air Duct Cleaning" style="width: 65px; height: 65px;">
                    <a href="https://www.acrepairofhoustontx.com/" style="text-decoration: none; font-size: 16px; color: #1f1f2e; font-weight: bold;">Services For Air Duct Cleaning</a>
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    <a href="https://acrepairofhoustontx.com
        ...
        <div class="container">
            <div class="row pt-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                <a class="text-white mb-2" href="https://www.acrepairofhoustontx.com/"><i class="fa fa-angle-right mr-2" style="color: #FF4800;"></i>Home</a>
                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    ...
                    <a href="https://www.acrepairofhoustontx.com/">
                    ...
                    <p><i class="fa fa-envelope mr-3 mt-4" style="color: #FF4800;"></i>service@acrepairofhoustontx.com</p>
                    <p><i class="fa-solid fa-earth-americas mr-3" style="color: #FF4800;"></i> www.acrepairofhoustontx.com</p>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5 " style="border-color: #3E3E4E !important; ">
        <div class="row">
            <div class="col-12 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white text-center">&copy; All Rights Reserved... www.acrepairofhoustontx.com
